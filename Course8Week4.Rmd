...
```
### Cross Validation
Now that we have reduced the number of variables, we create a training and test set for cross validation:
...
As the random forest has a accuracy of 0.99 compared to an accuracy of 0.49 of the decision tree, we will use the random forest method.

## Predicting

We then use our model to predict the test data.
